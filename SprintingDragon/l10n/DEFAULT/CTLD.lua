...
ctld.maxExtractDistance = 100 -- max distance from vehicle to troops to allow a group extraction
...
ctld.loadableGroups = {
    {name = "AAV-7", inf = 1}, -- will make a loadable group with 6 infantry, 2 MGs and 2 anti-tank for both coalitions
    {name = "LAV-25", mg = 1},
    {name = "Avenger", aa = 1},
    {name = "TOW", at = 1 },
...
function ctld.generateTroopTypes(_side, _countOrTemplate, _country)
    ...
    if type(_countOrTemplate) == "table" then
        ...
        if _countOrTemplate.aa then
            ...
            if _side == 2 then
                _troops = ctld.insertIntoTroopsArray("M1097 Avenger",_countOrTemplate.aa,_troops)
            else
        ...
        if _countOrTemplate.inf then
            ...
            if _side == 2 then
                _troops = ctld.insertIntoTroopsArray("AAV7",_countOrTemplate.inf,_troops)
            else
        ...
        if _countOrTemplate.mg then
            ...
            if _side == 2 then
                _troops = ctld.insertIntoTroopsArray("LAV-25",_countOrTemplate.mg,_troops)
            else
        ...
        if _countOrTemplate.at then
            ...
            _troops = ctld.insertIntoTroopsArray("M1045 HMMWV TOW",_countOrTemplate.at,_troops)
